...
main(void)
{
  ...
  //  MAP_SysTickIntEnable();
    ...
    //
    // Initialize a sample httpd server if using raw api
    //
   // httpd_init();
    //////////////////////////////////////
    // if using netconn api
 ...
 //   http_set_cgi_handlers(g_psConfigCGIURIs, NUM_CONFIG_CGI_URIS);
    ...
    //
    xTaskCreate( vLEDFlashTask, ( signed char * ) "LED", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY+1, NULL );
  //  sys_thread_new( ( signed char * ) "LED",vLEDFlashTask, NULL, configMINIMAL_STACK_SIZE,tskIDLE_PRIORITY+1);
